(function (e) {
    ...
    var t = function () {
        var t = function (e) {
            ...
            var i = e(t("svg")); e(i).attr("width", n); e(i).attr("height", r); var s = e(t("g")); e(i).append(s); return i
        };
        var r = function (t) {
            var n = document.createElement("div"); e(n).attr("class", t); var r = document.createElement("div"); e(n).append(r); return n
        };
        var i = function (n) {
            var r = e(t("path"));
            var i = {
                fill: "none", stroke: n.dail_stroke_color, "stroke-width": n.dail_stroke_width + "px", "stroke-linecap": "butt", "stroke-linejoin": "miter", "stroke-opacity": "1"
            };
            var s = ""; for (var o in i) {
                e(r).attr(o, i[o])
            }
            return r
        };
